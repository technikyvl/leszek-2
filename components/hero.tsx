      ...
      <motion.div style={{ y }} className="relative h-full">
        ...
        <div className="absolute inset-0 flex items-end justify-start z-10">
          <div className="text-left text-white px-6 pb-8">
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight uppercase">{t('hero.title')}</h1>
            <div className="flex items-center gap-4">
              ...
              <span className="text-white text-sm md:text-lg lg:text-xl font-semibold opacity-90">{t('hero.address')}</span>
            </div>
          </div>
        </div>
      </motion.div>
